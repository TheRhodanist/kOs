...
LOCK THROTTLE TO 0.5.   // 1.0 is the max, 0.0 is idle.
...
UNTIL SHIP:APOAPSIS > 125000 { //Remember, all altitudes will be in meters, not kilometers
...
PRINT "125km apoapsis reached, cutting throttle".
